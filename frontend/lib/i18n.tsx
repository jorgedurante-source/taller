...
export const translations: Translations = {
    ...
    summary_of_services: { en: 'Summary of Services', es: 'Resumen de Servicios' },
    my_vehicles: { en: 'My Vehicles', es: 'Mis Vehículos' },
    my_units: { en: 'My Units', es: 'Mis Unidades' },
    manage_registered_vehicles: { en: 'Manage the vehicles registered in the workshop.', es: 'Gestioná los vehículos registrados en el taller.' },
    request_appointment: { en: 'Request Appointment', es: 'Solicitar Turno' },
    all_up_to_date: { en: 'All Up to Date', es: 'Todo al día' },
    no_repairs_in_progress: { en: 'No repairs in progress right now.', es: 'No tenés reparaciones en curso ahora.' },
    vehicle_health_status: { en: 'Vehicle Health Status', es: 'Estado de Salud del Vehículo' },
    view_all_vehicles: { en: 'View All Vehicles', es: 'Ver todos los vehículos' },
    critical: { en: 'Critical', es: 'Crítico' },
    optimum: { en: 'Optimum', es: 'Óptimo' },
    history_required_prediction: { en: 'History required for prediction', es: 'Se requiere historial para predecir' },
    health_status: { en: 'Health Status', es: 'Estado de Salud' },
    next_suggested_service: { en: 'Next suggested service', es: 'Próximo service sugerido' },
    first_service_to_activate: { en: 'Complete your first service to activate smart tracking.', es: 'Realizá tu primer service para activar el seguimiento inteligente.' },
    clinical_history: { en: 'Clinical History', es: 'Historial Clínico' },
    no_registered_visits: { en: 'No past visits registered yet.', es: 'No registramos visitas pasadas aún.' },
    no_vehicles_loaded: { en: 'No vehicles loaded yet.', es: 'No tenés vehículos cargados aún' },
    load_first_now: { en: 'Load the first one now', es: 'Cargá el primero ahora' },
    register_unit: { en: 'Register Unit', es: 'Registrar Unidad' },
    vehicle_registration: { en: 'Vehicle Registration', es: 'Alta de Vehículo' },
    visit_history: { en: 'Visit History', es: 'Historial de visitas' },
    vibrating_now: { en: 'In progress', es: 'En curso' },
    task: { en: 'Task', es: 'Tarea' },
    last_movement: { en: 'Last Movement', es: 'Último Movimiento' },
    download_budget: { en: 'Download Budget', es: 'Descargar Presupuesto' },
    all_fine: { en: 'Everything is fine', es: 'Todo al día' },
    working_as_planned: { en: 'We are working as planned.', es: 'Estamos trabajando según lo previsto.' },
    ready_to_pickup: { en: 'Your vehicle is ready for pickup!', es: '¡Tu vehículo está listo para retirar!' },
    connected_client: { en: 'Connected Client', es: 'Cliente Conectado' },
    to_be_confirmed: { en: 'To be confirmed', es: 'Fecha a confirmar' },
    hs: { en: 'hs', es: 'hs' },
    ...
    kms: { en: 'km', es: 'km' },
    appearance_tab: { en: 'Appearance', es: 'Apariencia' },
    full_name: { en: 'Full Name', es: 'Nombre y Apellido' },
    ...
    Cerrado: { en: 'Closed', es: 'Cerrado' },
    liquidated: { en: 'Liquidated', es: 'Liquidado' },
    Liquidado: { en: 'Liquidated', es: 'Liquidado' },
    cancelled: { en: 'Cancelled', es: 'Cancelado' },
    canceled: { en: 'Cancelled', es: 'Cancelado' },
    ...
    'En reparación': { en: 'In Repair', es: 'En reparación' },
    'En Reparación': { en: 'In Repair', es: 'En reparación' },
    ...
    // Order Management
    orders_management: { en: 'Orders Management', es: 'Gestión de Órdenes' },
    orders_description: { en: 'Workshop work orders', es: 'Órdenes de trabajo del taller' },
    ...
    no_orders: { en: 'No orders found', es: 'No hay órdenes para mostrar' },
    loading_orders: { en: 'Loading orders...', es: 'Cargando órdenes...' },
    ...
    active_orders: { en: 'Active Orders', es: 'Órdenes Activas' },
    ...
    workshop_configuration: { en: 'Workshop configuration', es: 'Configuración taller' },
    ...
    finished_vehicles: { en: 'Finished vehicles', es: 'Vehículos terminados' },
    restricted_panel: { en: 'Restricted Panel', es: 'Panel Restringido' },
    restricted_panel_desc: { en: 'Your current plan or user role does not have the statistics and Control Panel module enabled.', es: 'Tu plan actual o el rol de tu usuario no tiene habilitado el módulo de estadísticas y Panel de Control.' },
    ...
    // Stats
    total_orders: { en: 'Total Orders', es: 'Total de Órdenes' },
    total_clients: { en: 'Total Clients', es: 'Total de Clientes' },
    monthly_income: { en: 'Monthly Income', es: 'Ingresos Mensuales' },
    active_vehicles: { en: 'Active Vehicles', es: 'Vehículos Activos' },
    financial_analysis: { en: 'Financial Analysis', es: 'Análisis Financiero' },
    ...
    historical_total_income: { en: 'Historical Total Income', es: 'Ingreso Total Histórico' },
    ...
    price_history: { en: 'Price History', es: 'Historial de Precios' },
    price_history_desc: { en: 'Price evolution per service', es: 'Evolución de precios del catálogo' },
    no_price_changes: { en: 'No price changes recorded yet.', es: 'No hay cambios de precio registrados aún.' },
    changes: { en: 'changes', es: 'cambios' },
    service_prices: { en: 'Service Prices', es: 'Precios por Servicio' },
    old_price: { en: 'Old Price', es: 'Precio Anterior' },
    new_price: { en: 'New Price', es: 'Precio Nuevo' },
    change_date: { en: 'Change Date', es: 'Fecha de Cambio' },
    price_stats: { en: 'Price Statistics', es: 'Estadísticas de Precios' },
    change_count: { en: 'Changes', es: 'Cambios' },
    min_price: { en: 'Min Price', es: 'Precio Mín' },
    max_price: { en: 'Max Price', es: 'Precio Máx' },
    last_avg_price: { en: 'Last Avg.', es: 'Último Promedio' },
    loading_stats: { en: 'Loading Statistics...', es: 'Cargando Estadísticas...' },
    list_view: { en: 'List View', es: 'Vista de Lista' },
    kanban_view: { en: 'Kanban View', es: 'Vista Kanban' },
    empty: { en: 'Empty', es: 'Vacío' },
    orders_completed: { en: 'orders completed', es: 'órdenes completadas' },
    export_data: { en: 'Export Data', es: 'Exportar Datos' },
    custom_excel_report: { en: 'Custom Excel Report', es: 'Generar Reporte Excel Personalizado' },
    report_type: { en: 'Report Type', es: 'Tipo de Reporte' },
    from_date: { en: 'From Date', es: 'Fecha Desde' },
    to_date: { en: 'To Date', es: 'Fecha Hasta' },
    download_excel: { en: 'Download Excel', es: 'Descargar Excel' },
    generating: { en: 'Generating...', es: 'Generando...' },
    close: { en: 'Close', es: 'Cerrar' },
    productivity_by_day: { en: 'Productivity by Day', es: 'Productividad por Día' },
    last_90_days: { en: 'Last 90 days', es: 'Últimos 90 días' },
    peak: { en: 'PEAK', es: 'PICO' },
    orders_by_hour: { en: 'Orders by hour of the day', es: 'Órdenes por hora del día' },
    avg_duration_by_service: { en: 'Average duration per service', es: 'Duración promedio por servicio' },
    days_from_open_to_delivery: { en: 'Days from opening to delivery', es: 'Días desde apertura a entrega' },
    overall_avg: { en: 'Overall Average', es: 'Promedio General' },
    year_to_year_comparison: { en: 'Year to Year Comparison', es: 'Comparativo Año a Año' },
    current_year: { en: 'Current Year', es: 'Año Actual' },
    previous_year: { en: 'Previous Year', es: 'Año Anterior' },
    vs_previous_year: { en: 'vs Previous Year', es: 'vs Año Anterior' },
    finances: { en: 'Finances', es: 'Finanzas' },
    ...
    add_vehicle: { en: 'Add Vehicle', es: 'Agregar Vehículo' },
    active: { en: 'Active', es: 'Activo' },
    inactive: { en: 'Inactive', es: 'Inactivo' },
    delete_vehicle: { en: 'Delete Vehicle', es: 'Eliminar Vehículo' },
    no_registered_vehicles: { en: 'No registered vehicles', es: 'No hay vehículos registrados' },
    no_description: { en: 'No description', es: 'Sin descripción' },
    no_registered_orders: { en: 'No registered orders', es: 'No hay órdenes registradas' },
    ...
    new_vehicle: { en: 'New Vehicle', es: 'Nuevo Vehículo' },
    register_vehicle: { en: 'Register Vehicle', es: 'Registrar Vehículo' },
    ...
    confirm_delete_item: { en: 'Delete this item?', es: '¿Eliminar este item?' },
    clients_management: { en: 'Clients Management', es: 'Gestión de Clientes' },
    vehicles_base: { en: 'Vehicles Base', es: 'Base de Vehículos' },
    ...
    no_vehicles_found: { en: 'No vehicles found', es: 'No se encontraron vehículos' },
    ...
    main_vehicle: { en: 'Main Vehicle', es: 'Vehículo Principal' },
    link_vehicle: { en: 'Link Vehicle', es: 'Vincular Vehículo' },
    ...
    km: { en: 'KM', es: 'KM' },
    current_km: { en: 'Current KM', es: 'KM Actuales' },
    enter_km_placeholder: { en: 'Ex: 125400', es: 'Ej: 125400' },
    search_clients_placeholder: { en: 'Search by name, nickname, phone or email...', es: 'Buscar por nombre, apodo, teléfono o email...' },
    search_vehicles_placeholder: { en: 'Search by brand, model, plate or owner...', es: 'Buscar por marca, modelo, patente o dueño...' },
    global_technical_file: { en: 'Global Technical File', es: 'Legajo técnico global' },
    loading_fleet: { en: 'Loading fleet...', es: 'Cargando parque automotor...' },
    history: { en: 'History', es: 'Historial' },

    // Communication Center
    messaging_center: { en: 'Messaging Center', es: 'Centro de Mensajería' },
    ...
    select_contact_chat: { en: 'Select a contact to read the conversation', es: 'Selecciona un contacto para leer la conversación' },
    chat_with: { en: 'Chat with', es: 'Chat con' },
    reply: { en: 'Reply', es: 'Responder' },
    sending: { en: 'Sending...', es: 'Enviando...' },
    send_reply: { en: 'Send Reply', es: 'Enviar Respuesta' },
    reply_placeholder: { en: 'Type your reply here...', es: 'Escribe tu respuesta aquí...' },
    ...
    // Sidebar & Process
    process_management: { en: 'Process Management', es: 'Gestión de Proceso' },
    ...
    appointment_notification_hint: { en: 'Upon saving, the client will be notified automatically if the template is active.', es: 'Al guardar, se le notificará al cliente automáticamente si la plantilla está activa.' },
    ...
    payment_updated: { en: 'Payment information updated', es: 'Información de cobro actualizada' },
    ...
    order_extension: { en: 'Order Extension', es: 'Ampliación de Orden' },
    catalog_service: { en: 'Catalog Service', es: 'Servicio Catálogo' },
    ...
    global_config: { en: 'Global Configuration', es: 'Configuración Global' },
    portal_config: { en: 'Portal & Communication', es: 'Portal y Comunicación' },
    theme_selection: { en: 'Theme & Appearance', es: 'Tema y Apariencia' },
    taxes_and_billing: { en: 'Taxes & Billing', es: 'Impuestos y Facturación' },
    ...
    services_catalog: { en: 'Services Catalog', es: 'Catálogo de Servicios' },
    audit_logs: { en: 'Audit Logs', es: 'Registros de Auditoría' },
    smtp_config: { en: 'SMTP Configuration', es: 'Configuración SMTP' },
    imap_config: { en: 'IMAP Configuration', es: 'Configuración IMAP' },
    ...
    change_password_hint: { en: 'Leave blank to keep current password', es: 'Dejar en blanco para mantener la contraseña actual' },
    new_password: { en: 'New Password', es: 'Nueva Contraseña' },

    // Public Portal
    consulting_status: { en: 'Checking repair status...', es: 'Consultando estado de reparación...' },
    order_not_found_portal: { en: 'Order not found or invalid token.', es: 'La orden no existe o el token es inválido.' },
    retry: { en: 'Retry', es: 'Reintentar' },
    repair_tracking: { en: 'Repair Tracking', es: 'Seguimiento de Reparación' },
    updated: { en: 'Updated', es: 'Actualizado' },
    appointment_date_portal: { en: 'Your Appointment Date', es: 'Fecha de tu Turno' },
    see_you_there: { en: 'We look forward to seeing you at the workshop!', es: '¡Te esperamos en el taller!' },
    ...
    no_address: { en: 'No address registered', es: 'Sin dirección registrada' },
    no_phone: { en: 'No phone registered', es: 'Sin teléfono' },

    // Portal Steps
    step_received: { en: 'Received', es: 'Recibido' },
    step_appointment: { en: 'Appointment', es: 'Turno' },
    step_approved: { en: 'Approved', es: 'Aprobado' },
    step_repairing: { en: 'Repairing', es: 'En Reparación' },
    ...
    business_hours_title: { en: 'Business Hours', es: 'Horarios de Atención' },
    mon_fri_label: { en: 'Monday to Friday', es: 'Lunes a Viernes' },
    sat_label: { en: 'Saturdays', es: 'Sábados' },
    ...
    manage_vehicles_desc: { en: 'Manage your vehicles and services', es: 'Gestioná tus vehículos y servicios' },
    ...
    i_am_mechanic: { en: 'I am a Mechanic', es: 'Soy Mecánico' },
    email_password_incorrect: { en: 'Incorrect email or password', es: 'Email o contraseña incorrectos' },
    ...
    module_not_enabled: { en: 'Module not enabled', es: 'Módulo no habilitado' },
    ...
    suppliers_management: { en: 'Suppliers Management', es: 'Gestión de Proveedores' },
    suppliers_description: { en: 'Manage your contact network and consult parts quotes.', es: 'Administrá tu red de contactos y consultá presupuestos de repuestos.' },
    ...
    inquiry_detail_hint: { en: 'Suppliers will receive the part details along with the vehicle information to quote.', es: 'Los proveedores recibirán el detalle del repuesto junto con la información del vehículo para cotizar.' },
    ...
    confirm_delete_supplier: { en: 'Are you sure you want to delete this supplier?', es: '¿Estás seguro de eliminar este proveedor?' },
    inquiry_sent_success: { en: 'Inquiry sent to {count} suppliers', es: 'Consulta enviada a {count} proveedores' },

    // Settings UI
    settings_panel_title: { en: 'Configuration Panel', es: 'Panel de Configuración' },
    settings_panel_subtitle: { en: 'Customize all aspects of your workshop system.', es: 'Personalizá todos los aspectos de tu sistema taller.' },
    recordatorios_tab: { en: 'REMINDERS', es: 'RECORDATORIOS' },
    templates_tab: { en: 'MESSAGES (TEMPLATES)', es: 'MENSAJES (PLANTILLAS)' },
    auto_sending_title: { en: 'AUTOMATIC SENDING', es: 'ENVÍO AUTOMÁTICO' },
    auto_sending_desc: { en: 'Configure when and how reminders are sent.', es: 'Configura cuándo y cómo se envían los recordatorios.' },
    active_service: { en: 'ACTIVE SERVICE', es: 'SERVICIO ACTIVO' },
    enable_daily_cron: { en: 'ENABLE DAILY CRON', es: 'HABILITA EL CRON DIARIO' },
    sending_time: { en: 'SENDING TIME', es: 'HORA DE ENVÍO' },
    reminders_processing_hint: { en: 'REMINDERS ARE PROCESSED ACCORDING TO THE SCHEDULED DATE IN EACH ORDER. IF THE WORKSHOP IS CONFIGURED NOT TO WORK ON SUNDAYS, THOSE MESSAGES WILL BE SENT THE FOLLOWING MONDAY.', es: 'LOS RECORDATORIOS SE PROCESAN SEGÚN LA FECHA PROGRAMADA EN CADA ORDEN. SI EL TALLER ESTÁ CONFIGURADO PARA NO TRABAJAR LOS DOMINGOS, ESOS MENSAJES SE ENVIARÁN EL SIGUIENTE LUNES.' },
    save_config: { en: 'SAVE CONFIGURATION', es: 'GUARDAR CONFIGURACIÓN' },
    workshop_identity: { en: 'Workshop Identity', es: 'Identidad del Taller' },
    workshop_logo_hint: { en: 'Workshop Logo (Click to change)', es: 'Logo del Taller (Hacé clic para cambiar)' },
    ...
    public_link: { en: 'Public Link (Share with Clients)', es: 'Enlace Público (Compartir con Clientes)' },
    copy_link: { en: 'Copy Link', es: 'Copiar Enlace' },
    copied: { en: 'Copied', es: 'Copiado' },
    portal_language_desc: { en: 'This is the language clients will see in the public panel and generated PDFs.', es: 'Este es el idioma en el que los clientes verán el panel público y los PDFs generados.' },
    income_calculation: { en: 'Income Calculation', es: 'Cálculo de Ingresos' },
    ...
    parts_profit_desc: { en: '* If you don\'t earn 100% of the part cost, lower the number.', es: '* Si no ganás el 100% de lo que sale el repuesto, bajá el número.' },
    ...
    personalize_templates_desc: { en: 'Personalize the messages sent for each repair status.', es: 'Personaliza los mensajes que se envían por cada estado de la reparación.' },
    ...
    token_usuario_desc: { en: 'Employee or mechanic name.', es: 'Nombre y apellido del empleado o mecánico.' },
    token_taller_desc: { en: 'Workshop name.', es: 'Nombre del taller.' },
    token_contacto_desc: { en: 'Email, Phone and Address of the workshop.', es: 'Email, Tel y Dirección del taller.' },
    ...
    password_label: { en: 'Password', es: 'Contraseña' },
    ...
    appearance_desc: { en: 'Choose the visual theme for your workshop. This change will apply to all your users and the Client Portal.', es: 'Elegí el tema visual de tu taller. Este cambio se aplicará a todos tus usuarios y al Portal del Cliente.' },
    add_to_catalog: { en: 'Add to Catalog', es: 'Agregar al Catálogo' },
    ...
    no_services_found: { en: 'No services loaded yet.', es: 'No hay servicios cargados aún.' },

    // Permissions
    perm_dashboard: { en: 'Dashboard', es: 'Panel Principal' },
    perm_clients: { en: 'Clients', es: 'Clientes' },
    perm_vehicles: { en: 'Vehicles', es: 'Vehículos' },
    perm_orders: { en: 'Orders', es: 'Órdenes' },
    ...
    perm_audit: { en: 'Audit', es: 'Auditoría' },
    ...
    theme_sunset_desc: { en: 'Warm and vibrant', es: 'Cálido y vibrante' },
    ...
    error_visor_desc: { en: 'Error viewer and technical logs per workshop', es: 'Visor de errores y logs técnicos por taller' },
    ...
    log_route: { en: 'Route/Method', es: 'Ruta/Método' },
    ...
    no_file_logs: { en: 'No critical logs registered in the filesystem', es: 'No hay logs críticos registrados en el sistema de archivos' },
