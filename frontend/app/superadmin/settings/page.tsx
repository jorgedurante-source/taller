    ...
    return (
        <div className="min-h-screen">
            <div className="max-w-4xl mx-auto">
                ...
                {message && (
                    <div className={`mb-8 p-6 rounded-[2rem] flex items-center gap-4 animate-in fade-in slide-in-from-top-4 duration-300 border-2 ${message.type === 'success' ? 'bg-emerald-50 text-emerald-700 border-emerald-100' : 'bg-red-50 text-red-700 border-red-100'
                        }`}>
                        ...
                        <span className="font-black italic uppercase tracking-tight">{message.text}</span>
                    </div>
                )}
