...
import { UserPlus, Mail, Phone, Lock, User, ArrowLeft, ShieldAlert } from 'lucide-react';
                ...
                <div className="p-10 space-y-8">
                    ...
                    {globalConfig?.allow_new_registrations === 'false' ? (
                        <div className="text-center space-y-4 py-8">
                            ...
                            <h2 className="text-xl font-black uppercase text-slate-800 tracking-tighter">Registros Suspendidos</h2>
                            <p className="text-sm font-bold text-slate-500">
                                En este momento el sistema no está aceptando nuevas registraciones. Por favor, intenta más tarde o comunícate con el taller.
                            </p>
                        </div>
                    ) : (
